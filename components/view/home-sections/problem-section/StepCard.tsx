  ...
  return (
    <article className="w-full h-full">
      <div className="w-full flex gap-4 justify-center items-center">
        <div className="w-[50%] bg-emerald-100 p-4 m-4 rounded-lg">
          <h2
        ...
        <div className="w-[50%] bg-fuchsia-200 p-4 m-4 rounded-lg">
          <h2
            className={`${nunitoBold.className} text-xl md:text-2xl lg:text-4xl xl:text-5xl h-fit overflow-y-hidden tracking-tighter`}
          >
      ...
      <div className="w-full flex gap-4 justify-center items-center">
        <div className="w-[50%] bg-violet-200 p-4 m-4 rounded-lg">
          <h2
            className={`${nunitoBold.className} text-xl md:text-2xl lg:text-4xl xl:text-5xl h-fit overflow-y-hidden tracking-tighter`}
          >
            STF are the #2 cause
        ...
        <div className="w-[50%] bg-amber-100 p-4 m-4 rounded-lg">
          <h2
            className={`${nunitoBold.className} text-xl md:text-2xl lg:text-4xl xl:text-5xl h-fit overflow-y-hidden tracking-tighter`}
          >
